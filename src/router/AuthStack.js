...
import {WELCOME_SCREEN, LOGIN_SCREEN, REGISTER_SCREEN, FORGET_PASS,CONFIRM_OTP_SCREEN,CREATE_NEW_PASS, OTP_FORGET_PASS_SCREEN, MAIN_TAB} from './ScreenName';
...
function AuthStack() {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name={OTP_FORGET_PASS_SCREEN} component={OTPFogetPass}></Stack.Screen>
