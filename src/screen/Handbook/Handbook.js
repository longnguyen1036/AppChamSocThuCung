...
const DATA = [
  {
    ...
    description:
      'Giống chó Alaskan Malamute hay chó Alaska, là một trong những giống chó kéo xe',
  },
  {
    ...
    description:
      'Hãy dừng ngay lại việc cho chó mèo ăn chay hoặc rau củ quả với..',
  },
  {
    id: '3ac68afc-c605-48d3-a4f8-fbd91aa97f63dsds',
    title: 'Hãy dừng lại nếu bạn đang cho chó mèo ăn chay',
    image: require('./../../assets/image/anhcamnang1.png'),
    description:
      'Hãy dừng ngay lại việc cho chó mèo ăn chay hoặc rau củ quả với..',
